...
@pytest.mark.parametrize('date_string, expected_parse_arg, expected_captures, expected_date', [
    ...
    (
            ...
            ' on 12/24/2015 at 2pm ',  # dateutil can now handle this
            {'timezones': []},
...
#     # TODO: looks like tz.gettz handles these now
#     (
...
#     )
# ])
# def test_parse_date_string_find_replace_nonexistent_tzinfo(date_string, expected_parse_arg, expected_captures,
#                                                            expected_date):
#     """
